...
def main(args):
    ...
    if type(report_df) != type(None):
        ...
        #create top report
        #top level df 
        top_df=compare.create_top_level_report(report_df,efo_traits=args.efo_traits,columns=columns,grouping_method=args.grouping_method,
...
if __name__=="__main__":
    ...
    parser.add_argument("--finngen-annotation-version",dest="fg_ann_version",type=str,default="r4",help="Finngen annotation release version: 3 or under or 4 or higher? Allowed values: 'r3' and 'r4'. Default 'r4' ")
