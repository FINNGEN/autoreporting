...
def fetch_gws(gws_fpath, sig_tresh_1,prefix,group,grouping_method,locus_width,sig_tresh_2,ld_r2,overlap,columns,ignore_region,cred_set_file, ld_api, extra_cols):
    """
