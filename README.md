...
--ld-assume-variant1-indexed | tabix LD only: assume the LD file is indexed by variant1 position, enabling a much narrower (1bp) fetch per lead. Verify against your LD file before enabling. | --ld-assume-variant1-indexed 
